          ...
          <div class="p-8">
            <form>
              ...
              <div class="flex justify-center items-center mb-6 botton-center">
                <button
                type="submit"
                class=" mt-16   text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Headdepartment account
              </button>
              </div>
