      ...
      <div class="p-64 rounded-lg shadow">
        ...
        >
          ...
          <div class="p-8 rounded-lg bg-primary-blue">
            <image
              src="https://images.pexels.com/photos/85773/pexels-photo-85773.jpeg?auto=compress&cs=tinysrgb&w=600"></image></div>
          <!-- Formside -->
          <div class="p-8">
            <form>
              <div
                class="text-center mb-2 input-group-password block text-2xl font-bold text-gray-900 text-center dark:text-white">Create a Student account</div>
                ...
                <div>
                  <form class="max-w-sm mx-auto">
                    ...
                    <select
                      id="countries"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      <option value="Female" selected>Famale</option>
              ...
              <div class="flex">
                <form class="mx-auto">
                    ...
                    <select
                      id="countries"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      <option value="Information Technology Engineering" selected>ITE</option>
                      <option value="Bio Engineering">Bio</option>
                      <option value="Supply Chain & Automation Engineering">SCA</option>
                      <option value="Telecommunication & Electric Engineering">TEE</option>
                      <option value="Enviromental Engineering">EE</option>
                ...
                <form class="mx-auto">
                    <label
                      for="countries"
                      class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Generation</label>
                    <select
                      id="countries"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      <option value="" selected>Gen 9</option>
                      ...
                      <option value="">Gen 7</option>
                      <option value="">Gen 8</option>
                      <option value="">Gen 9</option>
                      <option value="">Gen 10</option>
                    </select>
                </form>
            </div>
            <div class="flex mt-8">
                <form class="mx-auto">
                    ...
                    <select
                      id="countries"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      <option value="" selected>Year 1</option>
              ...
              <div class="flex justify-center items-center mb-6 botton-center">
                <button
                type="submit"
                class=" mt-16   text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Student account
              </button>
              </div>
              <div class="mb-9 text-center">
                <label
                  for="remember"
                  class="mt-2 ml-32 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                  >Already have an account?<a href="#" class="ml-2 text-blue-600 hover:underline dark:text-blue-500">Sign in</a>
                </label
                >
              </div>
            </form>
