<template>
    <div class="mt-16 w-full">
        <div class="max-w-md p-4 bg-white dark:border-2 border dark:border-gray-700 dark:bg-transparent shadow rounded-lg">
            ...
            <div class="w-full relative">
                ...
                <!-- FIlter -->
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white bg-my-blue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center inline-flex items-center dark:bg-my-blue-2 p-4 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
