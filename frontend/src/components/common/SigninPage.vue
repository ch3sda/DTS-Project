        ...
        <div class="mt-24 lg:grid bg-white md:grid-cols-2 rounded-lg shadow">
            ...
            <div class="px-16 p-8 md:px-32 rounded-lg md:rounded-r-lg">
                ...
                <form class="mt-4">
                    ...
                    <div class="mb-4">
                        <label for="input-group-password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Password
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                    ...
                    <div class="flex items-center justify-between w-full mb-4">
                        <div>
                            ...
                            <label for="remember-me" class=" text-xs md:text-sm font-medium text-gray-900 dark:text-gray-300">
                                Remember me
                            </label>
                        </div>
                        <a href="#" class="text-xs md:text-sm text-blue-600 hover:underline dark:text-blue-500">Forgot
                            Password?
                        </a>
                    </div>
